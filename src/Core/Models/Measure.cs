...
namespace Core.Models
{
    public class Measure : Enumeration<Measure>
    {
        ...
        public static readonly Measure BulkContainer = new Measure(4, "Intermediate bulk shipping container");
        public static readonly Measure FlexibleContainer = new Measure(4, "Flexible Intermediate bulk container");
